...
const places: Place[] = [
  ...
  { id: "lizhi", name: "立志樓", en: "Lizhi Building", category: "普通教室", filters: ["普通教室", "生活服務"], position: [48, 15], facilities: ["特教組", "員生合作社", "教練休息室", "語言教室", "視聽教室", "國中教室 18 間", "高一教室 13 間"], keywords: ["國中", "合作社", "文具", "用品", "特教", "高一", "語言"], route: "從校門往校園中央前進，經行政樓後向左走。", minutes: 4 },
  ...
  { id: "yuewen", name: "悅聞樓", en: "Yuewen Building", category: "專科教室", filters: ["行政服務", "專科教室"], position: [52, 5.5], facilities: ["圖書館", "創新教室", "國中部教師辦公室", "系統管理室", "電腦教室", "物理實驗室", "化學實驗室"], keywords: ["圖書館", "借書", "閱讀", "國中教師", "老師", "創新", "電腦", "實驗"], route: "從校門沿中央步道往北，經立志樓後繼續前行。", minutes: 5 },
